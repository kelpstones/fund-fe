...
export function TrustSafetyPage() {
  ...
  return (
    <main className="bg-white">
      <section
        className="relative overflow-hidden border-b border-base-300 bg-neutral text-white"
        data-reveal
      >
        ...
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="grid gap-4">
            {reviewSteps.map(([title, body], index) => (
              <article
                key={title}
                className="grid gap-4 rounded-md border border-base-300 bg-white p-5 shadow-sm transition-[transform,box-shadow] duration-200 ease-out md:hover:-translate-y-0.5 md:hover:shadow-md sm:grid-cols-[auto_1fr]"
                data-reveal
