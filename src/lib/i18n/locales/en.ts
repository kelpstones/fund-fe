...
Object.assign(enTranslations, {
  ...
  phoneInvalid: "Phone number must be 10 to 15 digits.",
  ...
  resourceAllStatus: "All statuses",
  resourceSearch: "Search",
  resourceActions: "Actions",
  resourceLoadError: "Failed to load data from backend",
  resourceEdit: "Edit",
  resourceChoose: "Choose",
  resourcePrevious: "Previous",
  resourceNext: "Next",
  resourceShowing: "Showing",
  resourceFrom: "of",
...
Object.assign(enTranslations, {
  ...
  umkmSalesDescription:
    "Submit sales reports for each active funding submission owned by your business.",
  ...
  profitBySalesPrompt:
    "Choose a sales report to view profit distributions generated by the system.",
