...
Object.assign(idTranslations, {
  ...
  nikInvalid: "NIK harus 16 digit angka.",
  phoneInvalid: "No. telp harus 10 sampai 15 digit angka.",
  ...
  resourceAllStatus: "Semua status",
  resourceSearch: "Cari",
  resourceActions: "Aksi",
  resourceLoadError: "Gagal memuat data dari backend",
  resourceEdit: "Edit",
  resourceChoose: "Pilih",
  resourcePrevious: "Sebelumnya",
  resourceNext: "Berikutnya",
  resourceShowing: "Menampilkan",
  resourceFrom: "dari",
  resourceData: "data",
  available: "Tersedia",
...
Object.assign(idTranslations, {
  ...
  umkmSalesDescription:
    "Kirim laporan penjualan untuk setiap pengajuan pendanaan aktif milik bisnis kamu.",
  ...
  profitBySalesPrompt:
    "Pilih laporan penjualan untuk melihat distribusi profit yang sudah dibuat sistem.",
